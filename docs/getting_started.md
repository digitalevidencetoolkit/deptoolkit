...
> **⚠️ AWS QLDB DEPRECATION WARNING**: AWS QLDB is being discontinued on **July 31, 2025**. While you can still create QLDB ledgers for testing/development purposes, this toolkit will require migration to an alternative solution before that date. **Production use is not recommended.** See [DEPRECATION.md](DEPRECATION.md) for more information.
